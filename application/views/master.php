...
<head>
	...
	<link href="<?php echo base_url('public/fontawesome/css/all.css') ?>" rel="stylesheet"> <!--load all styles -->
	<script defer src="<?php  echo base_url('public/fontawesome/js/all.js')?>"></script> <!--load all styles -->
	...
	<script defer src="<?php  echo base_url('public/fontawesome/js/brands.js')?>"></script>
	<script defer src="<?php  echo base_url('public/fontawesome/js/solid.js')?>"></script>
	<script defer src="<?php  echo base_url('public/fontawesome/js/fontawesome.js')?>"></script>

	<script src="https://code.jquery.com/jquery-3.6.0.js"></script>
	<script src="https://code.jquery.com/ui/1.13.0/jquery-ui.js"></script>
	<!-- animate CSS
	============================================ -->
	<link rel="stylesheet" href="<?php echo base_url('/bstore/css/animate.css') ?>">

	<!-- FANCYBOX CSS
	============================================ -->
	<link rel="stylesheet" href="<?php echo base_url('/bstore/css/jquery.fancybox.css') ?>">

	<!-- BXSLIDER CSS
	============================================ -->
	<link rel="stylesheet" href="<?php echo base_url('/bstore/css/jquery.bxslider.css')?>">

	<!-- MEANMENU CSS
	============================================ -->
	<link rel="stylesheet" href="<?php echo base_url('/bstore/css/meanmenu.min.css')?>">

	<!-- JQUERY-UI-SLIDER CSS
	============================================ -->
	<link rel="stylesheet" href="<?php echo base_url('/bstore/css/jquery-ui-slider.css')?>">

	<!-- NIVO SLIDER CSS
	============================================ -->
	<link rel="stylesheet" href="<?php echo base_url('/bstore/css/nivo-slider.css')?>">

	<!-- OWL CAROUSEL CSS
	============================================ -->
	<link rel="stylesheet" href="<?php echo base_url('/bstore/css/owl.carousel.css')?>">

	<!-- OWL CAROUSEL THEME CSS
	============================================ -->
	<link rel="stylesheet" href="<?php echo base_url('/bstore/css/owl.theme.css')?>">

	<!-- BOOTSTRAP CSS
	============================================ -->
	<link rel="stylesheet" href="<?php echo base_url('/bstore/css/bootstrap.min.css')?>">

	<!-- FONT AWESOME CSS
	============================================ -->
	<link rel="stylesheet" href="<?php echo base_url('/bstore/css/font-awesome.min.css')?>">

	<!-- NORMALIZE CSS
	============================================ -->
	<link rel="stylesheet" href="<?php echo base_url('/bstore/css/normalize.css')?>">

	<!-- MAIN CSS
	============================================ -->
	<link rel="stylesheet" href="<?php echo base_url('/bstore/css/main.css')?>">

	<!-- STYLE CSS
	============================================ -->
	<link rel="stylesheet" href="<?php echo base_url('/bstore/style.css')?>">

	<!-- RESPONSIVE CSS
	============================================ -->
	<link rel="stylesheet" href="<?php echo base_url('/bstore/css/responsive.css')?>">

	<!-- IE CSS
	============================================ -->
	<link rel="stylesheet" href="<?php echo base_url('/bstore/css/ie.css')?>">

	<!-- MODERNIZR JS
	============================================ -->
	<script src="<?php echo base_url('/bstore/js/vendor/modernizr-2.6.2.min.js')?>"></script>
</head>
<body class="index-2">
<!--[if lt IE 8]>
	...
	<div class="container">
		<div class="row">
			<div class="col-sm-12">
				<!-- LOGO START -->
				<div class="logo">
					<a href="index.html"><img src="<?php echo base_url('bstore/img/logo_new.png') ?>" alt="bstore logo" /></a>
				</div>
				<!-- LOGO END -->
...
<!-- jquery js -->
<script src="<?php echo base_url('/bstore/js/vendor/jquery-1.11.3.min.js')?>"></script>

<!-- fancybox js -->
<script src="<?php echo base_url('/bstore/js/jquery.fancybox.js')?>"></script>

<!-- bxslider js -->
<script src="<?php echo base_url('/bstore/js/jquery.bxslider.min.js')?>"></script>

<!-- meanmenu js -->
<script src="<?php echo base_url('/bstore/js/jquery.meanmenu.js')?>"></script>

<!-- owl carousel js -->
<script src="<?php echo base_url('/bstore/js/owl.carousel.min.js')?>"></script>

<!-- nivo slider js -->
<script src="<?php echo base_url('/bstore/js/jquery.nivo.slider.js')?>"></script>

<!-- jqueryui js -->
<script src="<?php echo base_url('/bstore/js/jqueryui.js')?>"></script>

<!-- bootstrap js -->
<script src="<?php echo base_url('/bstore/js/bootstrap.min.js')?>"></script>

<!-- wow js -->
<script src="<?php echo base_url('/bstore/js/wow.js')?>"></script>
<script>
	new WOW().init();
</script>
...
<!-- main js -->
<script src="<?php echo base_url('/bstore/js/main.js')?>"></script>
...
<script>
	if (localStorage.getItem('menuLeft') == null ){
			$.ajax({
				...
				localStorage.setItem('menuLeft',result.repalce('<div id="sub_category"></div>','<div id="sub_category">'+localStorage.getItem('menuSub')+'</div>'))
			})
	}else{
		$("#menu_view").html(localStorage.getItem('menuLeft'));
		console.log("222");
	}
